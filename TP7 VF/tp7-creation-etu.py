...
def main():
    try:
        ...
        # Script de création de la table type_logement pour effectuer une gestion des différents types de logement comme il y en a 8 cela représente une certaine simplicité
